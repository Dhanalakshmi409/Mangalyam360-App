...
class VendorDetailScreen5 extends StatefulWidget {
  final String vendor;

  VendorDetailScreen5({required this.vendor});

  @override
  _VendorDetailScreen5State createState() => _VendorDetailScreen5State();
}

class _VendorDetailScreen5State extends State<VendorDetailScreen5> {
